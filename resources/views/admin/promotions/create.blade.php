...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">Create New Promotion</h3>
        </div>
        <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="reward-items-container">
                                <div class="reward-item-row mb-2">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="number" class="form-control" name="reward_items[0][item_id]" 
                                                   placeholder="Item ID" required>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control" name="reward_items[0][item_amount]" 
                                                   placeholder="Amount" required>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="reward_items[0][item_name]" 
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('min_amount') is-invalid @enderror" 
                                   id="min_amount" name="min_amount" value="{{ old('min_amount') }}" required>
                            @error('min_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('bonus_type') is-invalid @enderror" 
                                ...
                                <option value="single" {{ old('bonus_type') == 'single' ? 'selected' : '' }}>
                                    Single (Claim once per user)
                                </option>
                                <option value="recurrent" {{ old('bonus_type') == 'recurrent' ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('claim_limit_per_user') is-invalid @enderror" 
                                   ...
                                   value="{{ old('claim_limit_per_user') }}" placeholder="Unlimited">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('global_claim_limit') is-invalid @enderror" 
                                   ...
                                   value="{{ old('global_claim_limit') }}" placeholder="Unlimited">
